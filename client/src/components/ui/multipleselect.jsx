  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "min-h-10 rounded-md text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2",
            {
          ...
          <div className="flex flex-wrap gap-3">
            {selected.map((option) => {
              return (
                ...
                key={option.value}
                className={cn(
                  "data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground bg-blue-900 p-2",
              ...
              >
                ...
                <button
                  className={cn(
                    "ml-1 rounded-full text-white  focus:outline-none focus:ring-1 focus:ring-white focus:ring-offset-0",
